        ...
        <Card className="border-2 border-green-200 shadow-sm hover:shadow-md transition-shadow">
          <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
            ...
            <Link href="/lesson?type=akkusativ" className="w-full">
              <Button size="lg" className="w-full bg-green-500 hover:bg-green-600 text-white rounded-xl shadow-sm hover:shadow-md h-14 text-lg">
                {c("start")}
              </Button>
            </Link>
          </CardContent>
        ...
        <Card className="border-2 border-blue-200 shadow-sm hover:shadow-md transition-shadow">
          <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
            ...
            <Link href="/lesson?type=dativ" className="w-full">
              <Button size="lg" className="w-full bg-blue-500 hover:bg-blue-600 text-white rounded-xl shadow-sm hover:shadow-md h-14 text-lg">
                {c("start")}
              </Button>
            </Link>
          </CardContent>
      ...
      <Card className="border-2 border-slate-200 shadow-sm bg-slate-50/50">
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-bold text-slate-800">{t("progress")}</h3>
            <span className="text-slate-500 font-medium">{totalPoints} / {sentencesCount} {t("sentences_learned")}</span>
          </div>
